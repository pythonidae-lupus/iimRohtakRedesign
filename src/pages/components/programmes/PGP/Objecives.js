...
import {Text, Box, Grid, GridItem, List, ListItem} from '@chakra-ui/react';


const AboutPGP = () => {
    return (
       <>
                <Text fontSize="48px" color="#fff">OBJECTIVES AND METHODOLOGY</Text>
                <Text color="#fff" fontSize="18px" mt={10}>
                ...
                <br></br>
                <br></br>
                Dui nunc mattis enim ut tellus. Lorem ipsum dolor sit amet consectetur adipiscing elit. 
